              ...
              <table class="table table-bordered" width="100%">    
                <thead>
                 ...
                 <tbody>
                    ...
                    <td>
                    <a href="edit_data_anggota.php?id_anggota=<?php echo $data['id_anggota']; ?>" class="btn btn-success" style= "width : 45px;"><i class ="far fa-edit"></i></a>
                    <a href="hapus_data_anggota.php?id_anggota=<?php echo $data['id_anggota']; ?>" 
                        name = "hapus" class="btn btn-danger" style= "width : 45px;" onClick = "return confirm('Yakin Ingin Hapus <?php echo "(".$data['nama'].")"; ?>')"><i class ="far fa-trash-alt"></i></a>
                    </td>
                    <?php
                        }
                    ?>
