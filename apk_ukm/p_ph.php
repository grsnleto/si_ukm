    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tambah Data Pengurus Harian</li>
        </ol>
            ...
            <form action="simpan_data_ph.php" method="post">
              ...
              <div class="form-group">
               ...
               <select name="jabatan" class="form-control">
                ...
                <option  name ="kt">Ketua</option>
                <option  name ="wk">Wakil Ketua</option>
                <option  name ="sk">Sekretaris</option>
                <option  name ="bd">Bendahara</option>
               </select>
               <br/>
