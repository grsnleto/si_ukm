            ...
            <form action="simpan_data.php" method="post">
              ...
              <div class="form-group">
               ...
               <select name="jurusan" class="form-control">
                <option>-- Pilih--</option>
                <option  name ="ket">Ketua</option>
                <option  name ="ad">Admin</option>
                <option  name ="ang">Anggota</option>
                <option  name ="bend">Bendahara</option>
                <option  name ="sek">Sekretaris</option>
               </select>
               <br/>
