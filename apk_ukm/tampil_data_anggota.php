        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            <div style = "text-align : right;">
                <a href ="p_mahasiswa.php"> <li class="btn btn-primary" ><span class="fa fa-clone"></span> Tambah Data</li></a>
            </div>
          </div>
            ...
            <div class="table-responsive">
              <table class="table table-bordered" width="100%">    
                ...
                <tbody>
                   ...
                   <!--  <td>
                    <a href="edit_data_anggota.php?id_anggota=<?php echo $data['id_anggota']; ?>" class="btn btn-warning" style= "width : 45%;">Ubah</a>
                    <a href="hapus_data_anggota.php?id_anggota=<?php echo $data['id_anggota']; ?>" 
