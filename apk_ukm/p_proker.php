      ...
      <div class="container-fluid">
       ...
       <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <p style="margin-bottom:10px;">
          <strong style="font-size:18pt;"><span class="fa fa-clone"></span> Tambah Data Proker</strong>
        </p>
        <hr>
           ...
           <div class="panel-body">
            ...
            <form action="simpan_data_proker.php" method="post">
               <div class="form-group">
                ...
                <input type="date" name="tgl_kgt" placeholder="" class="form-control" />
              </div>
               <br/>
              <div class="form-group">
                <label for="nama">Nama Kegiatan</label>
                <input type="text" name="nama" placeholder="nama kegiatan" class="form-control" />
              </div>
               <br/>
               <div class="form-group">
                <label for="nama">Jatuh Tempo Kegiatan</label>
                <input type="date" name="tempo_kgt" placeholder="" class="form-control" />
              </div>
