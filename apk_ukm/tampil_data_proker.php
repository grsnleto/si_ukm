        ...
        <div class="card mb-3">
          <div class="card-header" >
            ...
            <div style = "text-align : right;">
                <a href ="p_proker.php"> <li class="btn btn-primary" ><span class="fa fa-clone"></span> Tambah Data</li></a>
            </div>
          </div>
          <div class="card-body">
              ...
              <table class="table table-bordered" width="100%">    
                <thead>
                  ...
                  <tbody>
                    ...
                    <td>
                    <a href="edit_proker.php?id_kegiatan=<?php echo $data['id_kegiatan']; ?>" class="btn btn-success" style= "width : 45%;">Edit</a>
                    <a href="hapus_data_proker.php?id_kegiatan=<?php echo $data['id_kegiatan']; ?>" 
                        name = "hapus" class="btn btn-danger" style= "width : 45%;" onClick = "return confirm('Yakin Ingin Hapus Kagiatan <?php echo "(".$data['nama_kegiatan'].")!"; ?>')">Hapus</a>
                    </td>
                    <?php
                        }
                    ?>
